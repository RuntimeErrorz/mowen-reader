...
export const styles = StyleSheet.create({
  ...
  returnButton: { flexShrink: 0, flexDirection: 'row', alignItems: 'center', gap: 4, height: 34, paddingHorizontal: 9, borderWidth: 1, borderColor: '#BCD1CA' },
  ...
  historyComposer: { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: C.line, flexDirection: 'column', alignItems: 'stretch', backgroundColor: '#F3F5F0', paddingVertical: 7 },
  ...
  contextNoteCard: { width: 220, height: 76, borderWidth: StyleSheet.hairlineWidth, padding: 10, overflow: 'hidden' },
  contextNoteScroll: { flex: 1 },
  contextNoteScrollContent: { paddingRight: 3 },
  ...
  contextRequestBody: { marginTop: 7, borderWidth: StyleSheet.hairlineWidth, padding: 10 },
  ...
  thinkingTraceBody: { maxHeight: 190, marginHorizontal: 2, marginBottom: 8, paddingTop: 8, borderTopWidth: StyleSheet.hairlineWidth },
  ...
  questionBox: { minHeight: 86, borderWidth: 1, borderColor: '#CAD3CC', backgroundColor: C.white, paddingHorizontal: 8, paddingTop: 3, paddingBottom: 5, marginBottom: 4 },
