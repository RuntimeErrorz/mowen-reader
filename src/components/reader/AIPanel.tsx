...
import { ActivityIndicator, Image, KeyboardAvoidingView, Platform, Pressable, ScrollView, Text, TextInput, View, StyleSheet } from 'react-native';
...
import { getImageData, themedMarkdownStyles } from './readerUtils';
